...
namespace Index_Four_Chars_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Index Four Chars program where you will enter a string\nand an index and I will give you a string of four characters from that index.\nPress enter to continue.");
            Console.ReadLine();
        }

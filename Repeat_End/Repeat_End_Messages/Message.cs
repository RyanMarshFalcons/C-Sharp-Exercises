...
namespace Repeat_End_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Repeat End program where you will input a string and a\nnumber n that I will use to make n repetitions of the last n characters of your string. Press enter to continue.");
            Console.ReadLine();
        }

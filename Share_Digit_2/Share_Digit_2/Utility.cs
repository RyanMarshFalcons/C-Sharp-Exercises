    ...
    public class Utility
    {
        public int GetValidNumber()
        {
            ...
            while (isValidInput == false)
            {
                ...
                {
                    if (!CheckIfBetween10And99(input))
                    {
                        Message.MustBe10to99();
                    }
                    else
                    {
                        isValidInput = true;
        ...
        public bool CheckIfBetween10And99(string input)
        {
            return (int.Parse(input) >= 10) && (int.Parse(input) <= 99);
        }

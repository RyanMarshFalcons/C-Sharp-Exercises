...
namespace Index_Three_Chars_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Index Three Chars program where you will enter a string and an index and I will give you a string of three characters from that index.\nPress enter to continue.");
            Console.ReadLine();
        }

...
namespace Max_10_50_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Welcome to my Max 10 50 program where you will enter two numbers and I will tellyou which one of them is more powerful. You are free to enter any numbers that\nyou please, however only numbers between 10 and 50 have any power. Press enter\nto continue.");
            Console.ReadLine();
        }

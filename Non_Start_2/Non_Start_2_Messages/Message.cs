...
namespace Non_Start_2_Messages
{
    public class Message
    {
        ...
        {
            Console.WriteLine("Hello and welcome to my Non Start 2 program where you will input two strings and I will make a new string out of deleting their first characters and combining them. Press enter to continue.");
            Console.ReadLine();
        }

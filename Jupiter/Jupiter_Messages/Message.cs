...
namespace Jupiter_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Welcome to my Jupiter program where I will perform calculations about how you\nwould be different on the planet Jupiter. Press enter to continue.");
            Console.ReadLine();
        }

        public static void Selections()
        {
            Console.WriteLine("Would you like to:\nA) Find out how much you would weigh on Jupiter\nB) Find out how high you could jump on Jupiter\nC) Find out how old you would be on Jupiter\nD) Close the Jupiter program");
        }
        ...
        public static void DisplayResults(string typeOfMeasurement, string unitOfMeasurement, double amountOnJupiter)
        {
            Console.WriteLine($"\nYour {typeOfMeasurement} on Jupiter is {amountOnJupiter} {unitOfMeasurement}. Press enter to continue.");
            Console.ReadLine();
        }

        public static void ThankYou()
        {
            Console.WriteLine("\nThank you for taking the time to use my Jupiter program I hope that it was\neducational. Press enter to close the program.");
        }
    }
}

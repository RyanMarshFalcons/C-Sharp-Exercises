...
namespace Without_Z_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Without Z program where you will enter a string and thenI will remove any z or Zs at the begining and end or your string. Press enter tocontinue.");
            Console.ReadLine();
        }

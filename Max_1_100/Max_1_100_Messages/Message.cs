...
namespace Max_1_100_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Welcome to my Max 1 100 program where you will enter two numbers and I will tellyou which one of them is more powerful. You are free to enter any numbers that\nyou please, however only numbers between 1 and 100 have any power. Press enter\nto continue.");
            Console.ReadLine();
        }

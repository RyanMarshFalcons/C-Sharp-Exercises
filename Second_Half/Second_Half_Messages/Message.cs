...
namespace Second_Half_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Second Half program where you will input a string and I\nwill make a new string out of the second half of your string, if your string hasan odd number of characters I will include the full character that is cut in\nhalf in the middle. Press enter to continue.");
            Console.ReadLine();
        }

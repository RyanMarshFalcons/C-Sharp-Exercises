...
namespace Double_Characters_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Double Characters program where you will enter a string and then I will form a new string by doubling every character. Press enter to\ncontinue.");
            Console.ReadLine();
        }

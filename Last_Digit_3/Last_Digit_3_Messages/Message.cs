...
namespace Last_Digit_3_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Welcome to my Last Digit 3 program where you enter three numbers and I tell you\nwhether or not at least two of them have the same last digit. Press enter to\ncontinue.");
            Console.ReadLine();
        }
        ...
        {
            Console.WriteLine($"\nCongratulations at least two of your three numbers have the same last digit!!!");
        }

        public static void DontMatch()
        {
            Console.WriteLine($"\nUnfortunately none of your three numbers have the same last digit.");
        }

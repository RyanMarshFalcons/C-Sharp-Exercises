...
namespace Extra_Front_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Extra Front program where you will input a string and I\nwill make a string of three copies of the first two characters. Press enter to\ncontinue.");
            Console.ReadLine();
        }

...
namespace Without_X_Messages
{
    public class Message
    {
        public static void Welcome()
        {
            Console.WriteLine("Hello and welcome to my Without X program where you will enter a string and thenI will remove any x or Xs at the begining and end or your string. Press enter tocontinue.");
            Console.ReadLine();
        }
